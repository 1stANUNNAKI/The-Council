...
> نظام فيلق وكلاء منضبط: 11 وكيلاً متخصصاً حقيقيين + أكثر من 90 مهارة، يُركَّب بأمر واحد فوق أي محرر ذكاء اصطناعي، مع خط إنتاج إلزامي: تخطيط ← تنفيذ ← اختبارات ← بوابة أمنية ← توثيق — ويتحدّث نفسه ذاتياً عند كل إصدار.
...
├── agents/              ← 11 وكيل (صيغة OpenCode الأصلية)
